...
class CompanyService
{
    ...
    private function getSqls(int $id): array
    {
        return [
            ...
            'CREATE TABLE task_has_file (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, task_id INT DEFAULT NULL, url VARCHAR(512) DEFAULT NULL, user_id INT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))',
